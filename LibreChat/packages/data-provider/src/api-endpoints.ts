...
/* Notes */
export const notes = () => `${BASE_URL}/api/notes`;
export const note = (noteId: string) => `${notes()}/${encodeURIComponent(noteId)}`;
export const noteMove = (noteId: string) => `${note(noteId)}/move`;
export const noteLearningState = () => `${notes()}/learning-state`;
export const noteOrganize = () => `${notes()}/organize`;
