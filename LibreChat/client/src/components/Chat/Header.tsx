...
function Header({ notesExpanded = true, onNotesToggle }: HeaderProps) {
      ...
      <div className="hide-scrollbar flex w-full items-center justify-between gap-2 overflow-x-auto">
        ...
        {!isSmallScreen && (
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={() => onNotesToggle?.(!notesExpanded)}
              className={cn(
                'flex items-center gap-1.5 rounded-md px-2 py-1.5 text-sm hover:bg-surface-hover',
                notesExpanded && 'bg-surface-active',
              )}
