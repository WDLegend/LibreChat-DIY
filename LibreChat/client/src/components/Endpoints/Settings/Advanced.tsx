...
import { ROOT_PROMPT_NAME } from '~/utils/rootPrompt';
    ...
    <div className="grid grid-cols-5 gap-6">
      <div className="col-span-5 flex flex-col items-center justify-start gap-6 sm:col-span-3">
        ...
        <div className="grid w-full items-center gap-2">
          ...
          <div className="rounded-md border border-border-light bg-surface-secondary px-3 py-2 text-xs text-text-secondary">
            {ROOT_PROMPT_NAME} is always injected automatically for every new conversation and
            cannot be removed.
          </div>
          <TextareaAutosize
            id="promptPrefix"
